...
export const NegativeScreen: FC<
  NativeStackScreenProps<StackNavigatorParams, "negative">
> = () => {
  ...
  return (
    <YStack f={1} ai="center" p="$4" space>
      <YStack space="$2" maw={600}>
        ...
        <Paragraph ta="center">
          Selecione uma imagem para ser colocada no serasa
        </Paragraph>
      </YStack>
      <Separator />
      <XStack space="$2">
